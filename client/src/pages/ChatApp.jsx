  ...
  return (
    <div className="h-screen w-screen flex bg-slate-950 text-slate-200 overflow-hidden">
      ...
      {selectedUser ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-slate-900 border-l border-slate-800/50">
          ...
          <h3 className="text-xl font-medium text-slate-300">Antigravity Secure Chat</h3>
